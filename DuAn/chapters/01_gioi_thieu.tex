...
\subsection{Phạm vi}
Trong phạm vi ban đầu, đề tài tập trung vào quản lý dữ liệu cảm biến, UAV gateway, nhiệm vụ thu thập dữ liệu, cảnh báo và báo cáo. Các chức năng AI nâng cao, phân tích hình ảnh cây trồng và điều khiển bay trực tiếp cho UAV nằm ngoài phạm vi ban đầu.
