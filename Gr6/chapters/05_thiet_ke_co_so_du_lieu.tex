...
\begin{figure}[H]\centering\includegraphics[width=0.98\textwidth,height=0.68\textheight,keepaspectratio]{figures/erd.png}\caption{Mô hình ERD tổng quan}\end{figure}
...
\end{figure}
\section{Thiết kế mức vật lí}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,height=1\textheight,keepaspectratio]{diagrams/D.png}
\end{figure}
